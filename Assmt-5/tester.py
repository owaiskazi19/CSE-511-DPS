...
def getOpenConnection(user='owais', password='1234', dbname=DATABASE_NAME):
...
if __name__ == '__main__':
    try:
        ...
        loadRatings('ratings', '/Users/owais/ASU/Sem-2/DPS/Assmt-5/ratings.txt', con);
        loadMovies('movies', '/Users/owais/ASU/Sem-2/DPS/Assmt-5/movies.txt', con);
